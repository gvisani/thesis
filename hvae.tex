...
\begin{figure*}[t!]
    \centering
    \includegraphics[width=0.9\textwidth]{Quals/figures/hvae_for_quals.png}
...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=0.83\textwidth]{Quals/figures/figure2_beta=0.6.pdf}
...
\begin{figure*}
    ...
    \begin{tabular}{c}
        \includegraphics[width=0.8\textwidth]{Quals/figures/mnist/disentanglement/disentanglement-n_samples=1-seed=4.pdf} \\
        \includegraphics[width=0.8\textwidth]{Quals/figures/mnist/disentanglement/disentanglement-n_samples=1-seed=5.pdf} \\
        \includegraphics[width=0.8\textwidth]{Quals/figures/mnist/disentanglement/disentanglement-n_samples=1-seed=7.pdf}
    \end{tabular}
    }
...
\begin{figure*}[t!]
   % \centering
    \includegraphics[width=\textwidth]{Quals/figures/protein_figure.pdf}\\
...
%atom-type-specific clouds (C, N, O and S) and concatenating atom-type-specific features of the same degree. We use $N = 20$ and vary the maximum spherical degree $L$. 
...
(Figure~\ref{fig:umap_total_power}). In Figure~\ref{fig:lba_diagram}B we show the 
% Notably, the learned latent space is structured according to the secondary structure of the neighborhood's focal amino acid (Fig.~\ref{fig:lba_diagram}B).\\
