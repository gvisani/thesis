...
The contents of this chapter are published in~\citet{visani_t_2025}, under the title
\textit{T cell receptor specificity landscape revealed through de novo peptide design}.
This work was started by my mentor and former labmate Mike Pun.
His first-hand contributions can be found in his thesis~\citep{pun_rotationally_2023}.
...
\begin{figure}[th!]
\includegraphics[width=1.0\textwidth]{figures/schematic_0}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/affinity_figure_0}
...
TCR-pMHC complexes; see Table~\AffActInfoTable~and for template information
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/activity_all_0}
	...
	HERMES-{\em fixed}; see Table~\AffActInfoTable~for details on the
...
\begin{figure}[th!]
\centering
\includegraphics[width=0.63\textwidth]{figures/design_figure_final_4_0}
...
designs; see Appendix for experimental details.
...
\begin{figure}[th!]
\includegraphics[width=0.9\textwidth]{figures/entropy_TCRMHC_cartoon_0}
...
In this chapter, we introduced a structure-based machine learning model to predict TCR-pMHC
...
context of a bispecific antibody-mediated T-cell therapy~\cite{Hsiue2021-ag}. This result
...
interactions or antibody-mediated mechanisms. However, drawing more definitive conclusions about
...
This capability can be relevant to personalized peptide-based cancer vaccines, which aim to
...
Although this work primarily examines {MHC class I}-restricted peptides, the broad applicability of
...
accuracy of T-cell response predictions and improve the resulting {de novo} peptide design pipeline.
