...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/null_reconstruction/null_reconstruction_rmsd_per_resname__rmsd_avg.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figures/null_reconstruction/null_reconstruction_rmsd_per_resname__rmsd_avg__comparison_1700_vs_100_pdbs.pdf}
...
\begin{figure}
    ...
    % \resizebox{\textwidth}{!}{
    \begin{tabular}{c}
        \includegraphics[valign=m,width=1.0\textwidth]{figures/simple_task/simple_task_fixed_symmetries__training_curves.pdf}
        \\
        \includegraphics[valign=m,width=0.20\textwidth]{figures/simple_task/model_type_plus_split_legend.pdf}
    \end{tabular}
    % }
...
\begin{figure}
    ...
    \resizebox{\textwidth}{!}{
    \begin{tabular}{c c}
        \includegraphics[valign=m,width=0.85\textwidth]{figures/simple_task/simple_task_upweighting_later_chis_fixed_symmetries__test_predictions_by_model_type.pdf}
        &
...
\begin{figure}
    \centering
    \resizebox{0.9\textwidth}{!}{
    \includegraphics{figures/CASP13_error_per_aa__split=0.pdf}
    }
...
\begin{figure}
    \centering
    \resizebox{0.9\textwidth}{!}{
    \includegraphics{figures/CASP13_error_per_aa__split=1.pdf}
    }
    \figcaption{Angle Error distribution on CASP13 for H-PAcker$_5^{\ell_{\text{max}}=5}$,
    part 2.}{}
...
\begin{figure}
    \centering
    \resizebox{0.9\textwidth}{!}{
    \includegraphics{figures/CASP14_error_per_aa__split=0.pdf}
    }
...
\begin{figure}
    \centering
    \resizebox{0.9\textwidth}{!}{
    \includegraphics{figures/CASP14_error_per_aa__split=1.pdf}
    }
    \figcaption{Angle Error distribution on CASP14 for H-PAcker$_5^{\ell_{\text{max}}=5}$,
    part 2.}{}
