...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/zeroshot_models_against_each_other.png}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/radial_plots__no_numbers.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{figures/pairwise_pvalues_permutation_bucketed_by_sizereduced_precision_recall_f1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\linewidth]{figures/pvalues__bucketed_by_size__between_small_large_buckets__vertical.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{figures/t2837_and_megascale_pairwise_pvalues_permutation.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ddg_stability_single_structure_results_with_bp.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/t2837_pearsonr_broken_down.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/radial_plots__esmfold.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{figures/mean_of_abs_symmetric__significance_matrices_all_models_vs_aminoacid_properties__holm_within.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{figures/mean_of_abs_symmetric_all__average_prediction_matrices__spearman_matrix.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/mean_of_abs_symmetric__matrix_heatmaps__by_loc__part_1.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{figures/mean_of_abs_symmetric__matrix_heatmaps__by_loc__part_2.pdf}
    \figcaption{Model-averaged substitution matrices stratified by protein core and surface
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/ssym_antisymmetry_reversibility_score_results.pdf}
...
\begin{figure}
    \centering
\includegraphics[width=0.95\linewidth]{figures/pvalues_vs_random.pdf}\vspace{0.5cm}
\includegraphics[width=0.95\linewidth]{figures/pvalues_vs_blosum62.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/antigen_figure_types_of_mutations__2.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/denv_e_rosetta_hits_main_figure.pdf}
    \figcaption{\GM{Identifying new antigen-stabilizing mutations with HERMES for DENV-E.}}{
    \GM{
    ...
    \textit{Left}: proportion of Rosetta hits as a function of number of top-$k$ suggested mutations
    (for all methods except for Random, for which $k$ mutations are sampled at random from the pool
    ...
    We note that all BLOSUM62 suggestions had a score $\geq 1$.
    P-values were computed via Wilcoxon signed-rank test and corrected for multiple testing via
    Bonferroni within each panel.
    \textit{Right}: heatmap showing number of Rosetta hits (blue) and misses (red) for each amino-acid
    ...
    \label{fig:denv_e_rosetta_hits_main_figure}
\end{figure}


\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{figures/t2837_radial_plot_py_vs_bp.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{figures/hermes_relaxed_ablation.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth]{figures/rsvf_si_figure.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth]{figures/ha_si_figure.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth]{figures/hmpvf_si_figure.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\textwidth]{figures/denve_si_figure.pdf}
