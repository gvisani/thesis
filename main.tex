...
\title{Rational and data-driven protein modeling and design with local and rotation-equivariant neural networks}
...
\label{sec:overall_introduction}
...
\chapter{Supplement for chapter~\ref{sec:overall_hvae}}
\label{sec:hvae_appendix}
\input{appendix_text_hvae.tex}
\clearpage
\input{appendix_tables_and_figures_hvae.tex}

\chapter{Supplement for chapter~\ref{sec:overall_hpacker}}
\label{sec:hpacker_appendix}
\input{appendix_text_hpacker.tex}
\clearpage
\input{appendix_tables_and_figures_hpacker.tex}

\chapter{Supplement for chapter~\ref{sec:overall_hermes}}
\label{sec:hermes_appendix}
\input{appendix_text_hermes.tex}
\clearpage
\input{appendix_tables_and_figures_hermes.tex}

\chapter{Supplement for chapter~\ref{sec:overall_tcrpmhc}}
\label{sec:tcrpmhc_appendix}
\input{appendix_text_tcrpmhc.tex}
\clearpage
\input{appendix_tables_and_figures_tcrpmhc.tex}
