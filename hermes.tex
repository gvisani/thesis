...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.9\linewidth]{hermes/figures/antigen_design_concept.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=1.0\linewidth]{hermes/figures/antigen_figure_main_results_with_time.pdf}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=1.0\linewidth]{hermes/figures/rsv_f_rosetta_hits_main_figure.pdf}
