...
These choices are combined into a unified SO(3)-equivariant neural network framework, which I describe in
Chapter~\ref{sec:background}.

I then apply this framework to develop three models spanning diverse aspects of protein structure and function.
In Chapter~\ref{sec:hvae}, I introduce H-(V)AE, a rotationally equivariant (Variational) AutoEncoder that learns
...
In Chapter~\ref{sec:hpacker}, I present H-Packer, which uses the framework to tackle rotamer packing - the task of
...
In Chapter~\ref{sec:hermes}, I introduce HERMES, a structure-based model pre-trained to predict amino-acid propensities
...
I also characterize HERMES' strengths, weaknesses, and biases, and demonstrate its applicability to structure-based
vaccine antigen design.

Finally, in Chapter~\ref{sec:tcrpmhc}, I leverage HERMES to address the problem of T-Cell Receptor (TCR) specificity:
